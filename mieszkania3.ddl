...
DROP TABLE agent_to_rejon CASCADE CONSTRAINTS;

DROP TABLE biuro_wynajmujace CASCADE CONSTRAINTS;

DROP TABLE czarna_lista CASCADE CONSTRAINTS;

DROP TABLE data CASCADE CONSTRAINTS;

DROP TABLE dostepnosc CASCADE CONSTRAINTS;

DROP TABLE dostepnosc_to_agent CASCADE CONSTRAINTS;

DROP TABLE dostepnosc_to_pracownik CASCADE CONSTRAINTS;

DROP TABLE ekipa_remontowa CASCADE CONSTRAINTS;

DROP TABLE firma_sprzatajaca CASCADE CONSTRAINTS;

DROP TABLE kontakt CASCADE CONSTRAINTS;

DROP TABLE mieszkanie CASCADE CONSTRAINTS;

DROP TABLE najemca CASCADE CONSTRAINTS;

DROP TABLE pracownik CASCADE CONSTRAINTS;

DROP TABLE prezes CASCADE CONSTRAINTS;

DROP TABLE rejon CASCADE CONSTRAINTS;

DROP TABLE remont CASCADE CONSTRAINTS;

DROP TABLE remont_to_mieszkanie CASCADE CONSTRAINTS;

DROP TABLE spoldzielnia CASCADE CONSTRAINTS;

DROP TABLE wplaty CASCADE CONSTRAINTS;

DROP TABLE wynajem CASCADE CONSTRAINTS;

DROP TABLE wynajmujacy CASCADE CONSTRAINTS;
...
CREATE TABLE adres (
    ...
    najemca_id       NUMBER(11),
    wynajmujacy_id   NUMBER(11)
);
